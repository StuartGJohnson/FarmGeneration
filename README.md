...
An IsaacSim render of a similar orchard with assets generated by `tests/test_generate_assets.py` suggests that your can procedurally generate usable assets:
